...
export default function MyProjects() {
    ...
    }, [data, error, dataAdvances, errorAdvances, errorAddAdv, errorUpAdv, dataUpAdv, getProjects]); 
    ...
    return (
        <div className="bodyLider">
            <div className="container">
                ...
                <h2 id="titleLogo">Gestion de Mis Proyectos - Estudiante</h2> <br />
                                        ...
                                        return(
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <textarea disabled className="form-control form-control-sm" 
                                                        placeholder={ advance.Descripcion } /> }                                                    
                                                </td>
                                                <td>
                                                    <textarea readOnly className="form-control form-control-sm" 
                                                        value={ advance.Observaciones } />
                                                </td>   
                                                <td>
                                                    { advance.Estudiante._id === Estudiante ? 
